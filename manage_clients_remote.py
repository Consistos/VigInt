...
class RemoteClientManager:
    ...
    def __init__(self, server_url: Optional[str] = None, admin_key: Optional[str] = None):
        self.server_url = server_url or os.getenv('VIGINT_SERVER_URL', 'https://vigint-api-server.onrender.com')
...
Environment Variables:
  VIGINT_SERVER_URL    Server URL (default: https://vigint-api-server.onrender.com)
